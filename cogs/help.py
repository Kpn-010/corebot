...
MODULES = [
    ...
    },
    {
        ...
        "commands": [
            {
                "title": "Lookup",
                "description": "Look up a word's first definition.",
                "syntax": "cc ll <word>",
                "example": "cc ll serendipity",
                "permissions": "None",
                "aliases": "ll",
            },
            {
                "title": "Lookup — Part of Speech",
                "description": "Show the part of speech for a word.",
                "syntax": "cc ll <word> -pos",
                "example": "cc ll serendipity -pos",
                "permissions": "None",
                "aliases": "None",
            },
            {
                "title": "Lookup — Example",
                "description": "Show an example sentence using the word.",
                "syntax": "cc ll <word> -sentence",
                "example": "cc ll serendipity -sentence",
                "permissions": "None",
                "aliases": "None",
            },
            {
                "title": "Lookup — Origin",
                "description": "Show the etymology and word origin.",
                "syntax": "cc ll <word> -origin",
                "example": "cc ll serendipity -origin",
                "permissions": "None",
                "aliases": "None",
            },
            {
                "title": "Lookup — Synonyms",
                "description": "Show synonyms and antonyms for the word.",
                "syntax": "cc ll <word> -syn",
                "example": "cc ll serendipity -syn",
                "permissions": "None",
                "aliases": "None",
            },
            {
